...
var welcomeData={
    "nederlands":
        {
            "two" : "Verwelkomt u!",
            "three" :  "Bent u een student of een leerkracht?",
            "four" : "LEERKRACHT",
            "five" : "STUDENT",
        },
    ...
    "english":
        {
            "two" : "Welcomes you!",
            "three" : "Are you a student or a teacher?",
            "four" : "TEACHER",
            "five" : "STUDENT",
        }
}
...
var studentLoginData={
    ...
    "english":
        {
            "one" : "and have fun typing!",
            "two" : "Let's get logged in with your email",
            "three" : "CONTINUE WITH MY EMAIL",
        }
}
    ...
    "english":
        {
            ...
            "four" : "Show keyboard",
            "nine" : "Hear the letters out loud",
...
var expertStudentData={
    "nederlands":
        {
            "one" : "Studenten",
            "one2" : "Algemene informatie",
            "two" : "Voornaam:",
            "three" : "Achternaam:",
            "four" : "Email:",
            "five" : "Geslacht:",
...
link.forEach(el => {
    el.addEventListener('click', () => {
        ...
        if(getCookie("currentPage")=== "expertStudents"){
            ...
            if(attr === 'nederlands') {
                document.getElementById("myInput").placeholder='Zoeken';
            }
        }
        ...
        if(getCookie("currentPage")=== "expertEditProfile"){
            ...
            if(attr === 'nederlands') {
                document.getElementById("seven").value='Opslaan';
            }
        }
